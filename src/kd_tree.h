...
#include "pr_queue.h"
// Tian: Feb. 21, 2012
// This is a set of variables will be shared during a search through kd_tree
// They were used to be global variables that were not thread-safe.
// I created this structure and pass an object of this type through the searching.
struct ANNVariables
{
	ANNVariables() : ANNmaxPtsVisited(0){}
...
public:
	...
	virtual void ann_search(ANNdist, ANNVariables & var) = 0;		// tree search
	virtual void ann_pri_search(ANNdist, ANNVariables & var) = 0;	// priority search
	virtual void ann_FR_search(ANNdist, ANNVariables & var) = 0;	// fixed-radius search
...
public:
	...
	virtual void ann_FR_search(ANNdist, ANNVariables & var);		// fixed-radius search
};
