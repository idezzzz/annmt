...
default:
	...
	@echo "  make mingw-g++            for Mingw and g++"
	@echo "  make mingw-g++-debug            for Mingw and g++, debug version"
	@echo "  make linux-g++            for Linux and g++"
	@echo "  make linux-g++-debug            for Linux and g++, debug"
	@echo "  make macosx-g++           for Mac OS X and g++"
	@echo "  make macosx-g++-debug     for Mac OS X and g++, debug version"
